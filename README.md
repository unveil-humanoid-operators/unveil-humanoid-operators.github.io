...
- **83.4%** gender accuracy, and age, height, and weight inference with median absolute
  errors of 2.1 yr, 3.9 cm, and 5.3 kg on operators *never seen* during training.
